...
En esta clase, aprenderás todo sobre el entorno de R y RStudio, desde cómo descargar e instalar los programas, hasta cómo utilizar la interfaz de RStudio, crear proyectos, así como el uso de scripts y comandos básicos.
...
# Al adquirir el curso, serás capaz de crear, guardar, exportar e importar tablas, entre otras habilidades.
